...
export default function BottomNavBar({ show }) {
    ...
    // Definimos las variantes de animación mejoradas
    const variants = {
    ...
    // Efecto para actualizar el estado de animación
    useEffect(() => {
        if (show) {
        ...
        <AnimatePresence mode="wait">
            {show && (
                <motion.div 
                    ...
                    animate="visible"
                    exit="hidden"
                    className="sticky bottom-0 left-0 right-0 h-16 bg-gray-950 dark:bg-gray-950 border-t border-gray-800 dark:border-gray-800 z-50 w-full"
                    style={{ 
